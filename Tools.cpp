...
BWAPI::Unit Tools::getUnitType(BWAPI::UnitType type)
{
    // Cycle Through Units 

    std::cout << "Clled the function we wanted in the game here" << std::endl;
    ...
    // if we didn't find a unit to return, make sure we return nullptr
    return nullptr;
}
